...
void WelcomeScreen() {
	...
	glColor3f(0.0, 0.0, 0);
	glRasterPos2f(10, 60);
	Write("BMS INSTITUTE OF TECHNOLOGY AND MANAGEMENT");

	glColor3f(0.0, 0.0, 0);
	glRasterPos2f(40, 50);
	Write("Department of CSE");
	...
	glColor3f(0.0, 0.0, 0);
	glRasterPos2f(5, -10);
	Write("MiniProject of Computer Graphics and Laboratory");

	glColor3f(0.0, 0.0, 0);
	glRasterPos2f(33, -20);
	Write("Subject Code - 18CSL67");
	...
	glColor3f(0, 0, 0);
	glRasterPos2f(-10, -50);
	Write("RISHIK RAJ                                       SAURAV SINHA");

	glColor3f(0, 0, 0);
	glRasterPos2f(-10, -60);
	Write("1BY19CS120                                        1BY19CS138");

	glColor3f(0.18, 0.28, 0.29);
	glRasterPos2f(38, -80);
	Write("Under the guidence of,");

	glColor3f(0.18, 0.28, 0.29);
	glRasterPos2f(-25, -90);
	Write("Prof. Muneshwara M.S                                 Prof. Chethana C");

	glColor3f(0.18, 0.28, 0.29);
	glRasterPos2f(-25, -95);
	Write("Assistant prof.                                       Assistant prof.");

	glColor3f(0.18, 0.28, 0.29);
	glRasterPos2f(0, -110);
	Write("-----------------ABOUT Game Play:-----------------");

	glColor3f(0, 0, 1);
	glRasterPos2f(20, -120);
	Write("To Start Playing please");

	glColor3f(1, 0, 0);
	glRasterPos2f(80, -120);
	Write("PRESS 'n'");

	glColor3f(0, 0, 1);
	glRasterPos2f(20, -130);
	Write("And Game will end when Snake bites itself,");

	glColor3f(0, 0, 1);
	glRasterPos2f(20, -140);
	Write("Lets see how much you can score,");

	glColor3f(0, 0, 1);
	glRasterPos2f(45, -150);
	Write("ALL THE BEST!!");

	glColor3f(0, 0, 0);
	glRasterPos2f(55, -160);
	Write("ENJOY");
}
...
void GameStatus() {
	...
	glColor3f(1, 0, 0);
	glRasterPos2f(-105, 40);
	Write("Arrow symbol");

	glColor3f(0, 0, 1);
	glRasterPos2f(-65, 40);
	Write("for movement in left, right, up and down");
	...
	glColor3f(0, 0, 1);
	glRasterPos2f(-65, 30);
	Write("To move the disc in - X-axis");
	...
	glColor3f(0, 0, 1);
	glRasterPos2f(-65, 20);
	Write("To move the disc in - Y-axis");
	...
	glColor3f(0, 0, 1);
	glRasterPos2f(-65, 10);
	Write("To move the disc in - Z-axis");
...
int main(int argc, char *argv[]) {
	...
	glutCreateWindow("Snake Game - (1BY19CS120,138)");
